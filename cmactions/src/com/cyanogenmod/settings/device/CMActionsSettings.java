...
public class CMActionsSettings {
    ...
    private static final String GESTURE_SILENCE_NOTIFICATIONS_KEY = "gesture_silence_notifications";
    ...
    private boolean mSilenceNotificationsEnabled;
    ...
    private void loadPreferences(SharedPreferences sharedPreferences) {
        ...
        mSilenceNotificationsEnabled = sharedPreferences.getBoolean(GESTURE_SILENCE_NOTIFICATIONS_KEY, false);
    }
    ...
    public boolean isSilenceNotificationsEnabled() {
        return mSilenceNotificationsEnabled;
    }
    ...
    private SharedPreferences.OnSharedPreferenceChangeListener mPrefListener =
        ...
        public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
            ...
            if (GESTURE_CAMERA_KEY.equals(key)) {
                ...
                mPickUpGestureEnabled = sharedPreferences.getBoolean(GESTURE_PICK_UP_KEY, false);
            } else if (GESTURE_SILENCE_NOTIFICATIONS_KEY.equals(key)) {
                mSilenceNotificationsEnabled = sharedPreferences.getBoolean(GESTURE_SILENCE_NOTIFICATIONS_KEY, false);
            } else {
                updated = false;
            }
