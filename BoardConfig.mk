...
# Kernel
BOARD_KERNEL_CMDLINE := console=none androidboot.hardware=qcom msm_rtb.filter=0x37 ehci-hcd.park=3 vmalloc=400M loop.max_part=7 androidboot.selinux=permissive
...
BOARD_VENDOR_SEPOLICY_DIRS += device/motorola/victara/sepolicy
